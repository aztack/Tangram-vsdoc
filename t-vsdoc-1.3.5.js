//-------------------------------------------------------
//-* Vsdoc for Tangram 2011-04-18 19-19-45 Generated *-
//-------------------------------------------------------
T = baidu = {};
...
baidu.page.rules = null; //当前对象的规则列表
...
baidu.number.pad = function(source, length){
	...
	/// <para>Integar timeOut 超时时间，超过这个时间将不再响应本请求，并触发onfailure函数</para>  
	...
	/// <para>Integar timeOut 超时时间(单位：ms)，超过这个时间将不再响应本请求，并触发onfailure函数</para>  
	/// <para>Function onfailure timeOut设定后才生效，到达超时时间时触发本函数</para>  
	/// </summary>
	/// <param type="string" name="url">加载数据的url.</param>
	/// <param type="Function|string" name="callback">服务器端调用的函数或函数名.</param>
	...
	/// <para>Boolean options.capture 鼠标拖曳粘滞.</para>  
	/// <para>Object options.mouseEvent 键名为clientX和clientY的object，若不设置此项，默认会获取当前鼠标位置.</para>  
	/// <para>Function options.onbeforedragstart drag开始前触发（即鼠标按下时）.</para>  
	/// <para>Function options.ondragstart drag开始时触发.</para>  
	/// <para>Function options.ondrag drag进行中触发.</para>  
	/// <para>Function options.ondragend drag结束时触发.</para>  
	/// <para>HTMLElement options.handler 用于拖拽的手柄，比如dialog的title.</para>  
	/// <para>Function options.toggle 在每次ondrag的时候，会调用这个方法判断是否应该停止拖拽。如果此函数返回值为false，则停止拖拽.</para>  
	/// </summary>
	/// <param type="string|HTMLElement" name="element">元素或者元素的ID.</param>
	/// <param type="Object" name="options">选项.</param>
	/// <returns type="Draggable Instance">拖拽实例，包含cancel方法，可以停止拖拽.</returns>
	...
	/// baidu.event._eventFilter._crossElementBoundary(listener, e);
	/// </summary>
	/// <param type="function" name="listener">要触发的函数</param>
	/// <param type="DOMEvent" name="e">DOM事件</param>
	...
	/// baidu.array.every(source, iterator);
	/// </summary>
	/// <param type="Array" name="source">需要判断的数组.</param>
	...
	/// baidu.array.some(source, iterator);
	/// </summary>
	/// <param type="Array" name="source">需要判断的数组.</param>
	/// <param type="Function" name="iterator">判断函数.</param>
	/// <param type="Object" name="thisObject">函数调用时的this指针，如果没有此参数，默认是当前遍历的数组</param>
